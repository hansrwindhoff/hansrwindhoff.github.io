...
(function(Buffer) {
  ...
  var suite = {
    ...
    "compactEmpty": function(test) {
      ...
      test.strictEqual(bb.array.byteLength, 4);
      test.done();
    },
    ...
    "zigZagEncode/Decode32/64": function(test) {
      ...
      values = [[Long.MAX_SIGNED_VALUE, Long.MAX_UNSIGNED_VALUE.subtract(Long.ONE)], [Long.MIN_SIGNED_VALUE, Long.MAX_UNSIGNED_VALUE]];
      for (i = 0; i < values.length; i++) {
    ...
    "write/readVarint32": function(test) {
      var values = [[1, 1], [300, 300], [0x7FFFFFFF, 0x7FFFFFFF], [0xFFFFFFFF, -1], [0x80000000, -2147483648]];
      var bb = new ByteBuffer(5);
      for (var i = 0; i < values.length; i++) {
    ...
    "write/readVarint64": function(test) {
      var Long = ByteBuffer.Long;
      var values = [[Long.ONE], [Long.fromNumber(300)], [Long.fromNumber(0x7FFFFFFF)], [Long.fromNumber(0xFFFFFFFF)], [Long.fromBits(0xFFFFFFFF, 0x7FFFFFFF)], [Long.fromBits(0xFFFFFFFF, 0xFFFFFFFF)]];
    ...
    "write/readZigZagVarint32": function(test) {
      var values = [0, 1, 300, -300, 2147483647, -2147483648];
      var bb = new ByteBuffer(10);
      for (var i = 0; i < values.length; i++) {
    ...
    "write/readZigZagVarint64": function(test) {
      var Long = ByteBuffer.Long;
      var values = [Long.ONE, 1, Long.fromNumber(-3), Long.fromNumber(300), Long.fromNumber(-300), Long.fromNumber(0x7FFFFFFF), Long.fromNumber(0x8FFFFFFF), Long.fromNumber(0xFFFFFFFF), Long.fromBits(0xFFFFFFFF, 0x7FFFFFFF), Long.fromBits(0xFFFFFFFF, 0xFFFFFFFF)];
      var bb = new ByteBuffer(10);
      for (var i = 0; i < values.length; i++) {
    ...
    "encode/decode64": function(test) {
      var values = [["ProtoBuf.js", "UHJvdG9CdWYuanM="], ["ProtoBuf.j", "UHJvdG9CdWYuag=="], ["ProtoBuf.", "UHJvdG9CdWYu"], ["ProtoBuf", "UHJvdG9CdWY="]];
      for (var i = 0; i < values.length; i++) {
        var str = values[i][0],
            b64 = values[i][1];
