    ...
    function q(l) {
      ...
      c.wrap = function(a, b, d) {
        ...
        if (null === a || "object" !== typeof a)
          throw Error("Cannot wrap null or non-object");
        if (c.isByteBuffer(a))
          return c.prototype.clone.call(a);
        a.array ? a = a.array : a.buffer && (a = a.buffer);
        if (!(a instanceof ArrayBuffer))
          throw Error("Cannot wrap buffer of type " + typeof a + ", " + a.constructor.name);
        b = new c(0, d, !0);
        b.array = a;
      ...
      c.prototype.slice = function(a, b) {
        if (null == this.array)
          throw Error(this + " cannot be sliced: Already destroyed");
        ...
        if (0 > a || a > this.array.byteLength || 1 > b || b > this.array.byteLength)
          throw Error(this + " cannot be sliced: Index out of bounds (0-" + this.array.byteLength + " -> " + a + "-" + b + ")");
        d = this.clone();
        d.offset = a;
        d.length = b;
        return d;
      ...
      c.prototype.mark = function(a) {
        if (null == this.array)
          throw Error(this + " cannot be marked: Already destroyed");
        a = "undefined" !== typeof a ? parseInt(a, 10) : this.offset;
        if (0 > a || a > this.array.byteLength)
          throw Error(this + " cannot be marked: Offset to mark is less than 0 or bigger than the capacity (" + this.array.byteLength + "): " + a);
        this.markedOffset = a;
        return this;
      };
      c.prototype.reset = function() {
        if (null === this.array)
          throw Error(this + " cannot be reset: Already destroyed");
      ...
      c.prototype.compact = function() {
        if (null == this.array)
          throw Error(this + " cannot be compacted: Already destroyed");
        this.offset > this.length && this.flip();
        if (this.offset === this.length)
          return this.array = new ArrayBuffer(0), this.view = null, this;
        if (0 === this.offset && this.length === this.array.byteLength)
          return this;
        ...
        this.array = b;
        this.markedOffset = this.markedOffset >= this.offset ? this.markedOffset - this.offset : -1;
        this.offset = 0;
      ...
      c.prototype.reverse = function() {
        if (null === this.array)
          throw Error(this + " cannot be reversed: Already destroyed");
      ...
      c.prototype.append = function(a, b) {
        ...
        if (null === a.array)
          throw Error(a + " cannot be appended to " + this + ": Already destroyed");
      ...
      c.prototype.prepend = function(a, b) {
        a instanceof c || (a = c.wrap(a));
        if (null === a.array)
          throw a + " cannot be prepended to " + this + ": Already destroyed";
        var d = a.length - a.offset;
        if (0 == d)
          return this;
        0 > d && (a = a.clone().flip(), d = a.length - a.offset);
      ...
      c.prototype.readInt8 = function(a) {
        ...
        if (a >= this.array.byteLength)
          throw Error("Cannot read int8 from " + this + " at " + a + ": Capacity overflow");
      ...
      c.prototype.readUint8 = function(a) {
        a = "undefined" !== typeof a ? a : (this.offset += 1) - 1;
        if (a + 1 > this.array.byteLength)
          throw Error("Cannot read uint8 from " + this + " at " + a + ": Capacity overflow");
      ...
      c.prototype.readInt16 = function(a) {
        ...
        if (a + 2 > this.array.byteLength)
          throw Error("Cannot read int16 from " + this + " at " + a + ": Capacity overflow");
      ...
      c.prototype.readInt32 = function(a) {
        ...
        if (a + 4 > this.array.byteLength)
          throw Error("Cannot read int32 from " + this + " at " + a + ": Capacity overflow");
      ...
      c.prototype.readUint32 = function(a) {
        a = "undefined" !== typeof a ? a : (this.offset += 4) - 4;
        if (a + 4 > this.array.byteLength)
          throw Error("Cannot read uint32 from " + this + " at " + a + ": Capacity overflow");
      ...
      c.prototype.readFloat32 = function(a) {
        a = "undefined" !== typeof a ? a : (this.offset += 4) - 4;
        if (null === this.array || a + 4 > this.array.byteLength)
          throw Error("Cannot read float32 from " + this + " at " + a + ": Capacity overflow");
      ...
      c.prototype.readFloat64 = function(a) {
        ...
        if (null === this.array || a + 8 > this.array.byteLength)
          throw Error("Cannot read float64 from " + this + " at " + a + ": Capacity overflow");
      ...
      l && (c.prototype.writeInt64 = function(a, b) {
        b = "undefined" !== typeof b ? b : (this.offset += 8) - 8;
        ...
        a = "undefined" !== typeof a ? a : (this.offset += 8) - 8;
        if (null === this.array || a + 8 > this.array.byteLength)
          throw this.offset -= 8, Error("Cannot read int64 from " + this + " at " + a + ": Capacity overflow");
        ...
        this.ensureCapacity(b + 8);
        this.littleEndian ? (this.view.setUint32(b, a.getLowBitsUnsigned(), !0), this.view.setUint32(b + 4, a.getHighBitsUnsigned(), !0)) : (this.view.setUint32(b, a.getHighBitsUnsigned(), !1), this.view.setUint32(b + 4, a.getLowBitsUnsigned(), !1));
        return this;
      ...
      }, c.prototype.writeLong = c.prototype.writeInt64, c.prototype.readLong = c.prototype.readInt64);
      ...
      c.prototype.writeVarint32 = function(a, b) {
        ...
        var e = this.view,
            f = 0;
        e.setUint8(b, a | 128);
        128 <= a ? (e.setUint8(b + 1, a >> 7 | 128), 16384 <= a ? (e.setUint8(b + 2, a >> 14 | 128), 2097152 <= a ? (e.setUint8(b + 3, a >> 21 | 128), 268435456 <= a ? (e.setUint8(b + 4, a >> 28 & 127), f = 5) : (e.setUint8(b + 3, e.getUint8(b + 3) & 127), f = 4)) : (e.setUint8(b + 2, e.getUint8(b + 2) & 127), f = 3)) : (e.setUint8(b + 1, e.getUint8(b + 1) & 127), f = 2)) : (e.setUint8(b, e.getUint8(b) & 127), f = 1);
      ...
      c.prototype.readVarint32 = function(a) {
        ...
        var d = 0,
            ...
            g = 0;
        do
          e = f.getUint8(a + d), d < c.MAX_VARINT32_BYTES && (g |= (e & 127) << 7 * d >>> 0), ++d;
 while (e & 128);
        g |= 0;
      ...
      c.prototype.readZigZagVarint32 = function(a) {
      ...
      l && (c.prototype.writeVarint64 = function(a, b) {
        ...
        h = c.getUint8(a++);
        f = h & 127;
        if (h & 128 && (h = c.getUint8(a++), f |= (h & 127) << 7, h & 128 && (h = c.getUint8(a++), f |= (h & 127) << 14, h & 128 && (h = c.getUint8(a++), f |= (h & 127) << 21, h & 128 && (h = c.getUint8(a++), g = h & 127, h & 128 && (h = c.getUint8(a++), g |= (h & 127) << 7, h & 128 && (h = c.getUint8(a++), g |= (h & 127) << 14, h & 128 && (h = c.getUint8(a++), g |= (h & 127) << 21, h & 128 && (h = c.getUint8(a++), k = h & 127, h & 128 && (h = c.getUint8(a++), k |= (h & 127) << 7, h & 128))))))))))
          throw Error("Data must be corrupt: Buffer overrun");
      ...
      c.decodeUTF8Char = function(a, b) {
        ...
        if (0 == (d & 128))
          ...
          c = a.readUint8(b + 1), d = (d & 31) << 6 | c & 63, b += 2;
        else if (224 == (d & 240))
          c = a.readUint8(b + 1), f = a.readUint8(b + 2), d = (d & 15) << 12 | (c & 63) << 6 | f & 63, b += 3;
        else if (240 == (d & 248))
          c = a.readUint8(b + 1), f = a.readUint8(b + 2), g = a.readUint8(b + 3), d = (d & 7) << 18 | (c & 63) << 12 | (f & 63) << 6 | g & 63, b += 4;
        else if (248 == (d & 252))
          c = a.readUint8(b + 1), f = a.readUint8(b + 2), g = a.readUint8(b + 3), k = a.readUint8(b + 4), d = (d & 3) << 24 | (c & 63) << 18 | (f & 63) << 12 | (g & 63) << 6 | k & 63, b += 5;
        else if (252 == (d & 254))
          c = a.readUint8(b + 1), f = a.readUint8(b + 2), g = a.readUint8(b + 3), k = a.readUint8(b + 4), h = a.readUint8(b + 5), d = (d & 1) << 30 | (c & 63) << 24 | (f & 63) << 18 | (g & 63) << 12 | (k & 63) << 6 | h & 63, b += 6;
        else
          throw Error("Cannot decode UTF8 character at offset " + b + ": charCode (0x" + d.toString(16) + ") is invalid");
        return {
          "char": d,
          length: b - l
        };
      ...
      c.encodeUTF8Char = function(a, b, c) {
        var e = c;
        if (0 > a)
          throw Error("Cannot encode UTF8 character: charCode (" + a + ") is negative");
        if (128 > a)
          b.writeUint8(a & 127, c), c += 1;
        else if (2048 > a)
          b.writeUint8(a >> 6 & 31 | 192, c).writeUint8(a & 63 | 128, c + 1), c += 2;
        else if (65536 > a)
          b.writeUint8(a >> 12 & 15 | 224, c).writeUint8(a >> 6 & 63 | 128, c + 1).writeUint8(a & 63 | 128, c + 2), c += 3;
        else if (2097152 > a)
          b.writeUint8(a >> 18 & 7 | 240, c).writeUint8(a >> 12 & 63 | 128, c + 1).writeUint8(a >> 6 & 63 | 128, c + 2).writeUint8(a & 63 | 128, c + 3), c += 4;
        else if (67108864 > a)
          b.writeUint8(a >> 24 & 3 | 248, c).writeUint8(a >> 18 & 63 | 128, c + 1).writeUint8(a >> 12 & 63 | 128, c + 2).writeUint8(a >> 6 & 63 | 128, c + 3).writeUint8(a & 63 | 128, c + 4), c += 5;
        else if (2147483648 > a)
          b.writeUint8(a >> 30 & 1 | 252, c).writeUint8(a >> 24 & 63 | 128, c + 1).writeUint8(a >> 18 & 63 | 128, c + 2).writeUint8(a >> 12 & 63 | 128, c + 3).writeUint8(a >> 6 & 63 | 128, c + 4).writeUint8(a & 63 | 128, c + 5), c += 6;
        else
          throw Error("Cannot encode UTF8 character: charCode (0x" + a.toString(16) + ") is too large (>= 0x80000000)");
        return c - e;
      };
      c.calculateUTF8Char = function(a) {
        if (0 > a)
          throw Error("Cannot calculate length of UTF8 character: charCode (" + a + ") is negative");
        if (128 > a)
          return 1;
        if (2048 > a)
          return 2;
      ...
      c.a = function(a) {
        ...
        for (var b = 0,
            d = 0,
            e = a.length; d < e; ++d)
          b += c.calculateUTF8Char(a.charCodeAt(d));
        return b;
      };
      ...
      c.encode64 = function(a) {
        ...
        var b,
            ...
            h = [];
        do
          b = a.readUint8(g++), d = a.length > g ? a.readUint8(g++) : 0, e = a.length > g ? a.readUint8(g++) : 0, f = b << 16 | d << 8 | e, b = f >> 18 & 63, d = f >> 12 & 63, e = f >> 6 & 63, f &= 63, h[k++] = m.charAt(b) + m.charAt(d) + m.charAt(e) + m.charAt(f);
 while (g < a.length);
        g = h.join("");
      ...
      c.decode64 = function(a, b) {
        if ("string" !== typeof a)
          throw Error("Illegal argument: Not a string");
        var d,
            e,
            f,
            g,
        ...
        do {
          ...
          if (0 > d || 0 > e || 0 > g || 0 > k)
            throw Error("Illegal argument: Not a valid base64 encoded string");
          f = d << 18 | e << 12 | g << 6 | k;
          d = f >> 16 & 255;
          e = f >> 8 & 255;
          f &= 255;
      ...
      c.encodeHex = function(a) {
        ...
        for (var b,
            ...
            e = a.offset,
            f = a.length; e < f; ++e)
          b = a.view.getUint8(e).toString(16).toUpperCase(), 2 > b.length && (b = "0" + b), d.push(b);
        return d.join("");
      };
      c.decodeHex = function(a, b) {
        if ("string" !== typeof a)
          throw Error("Illegal argument: Not a string");
        if (0 !== a.length % 2)
          throw Error("Illegal argument: Not a hex encoded string");
        for (var d = new c(a.length / 2, b),
            e = 0,
            f = a.length; e < f; e += 2)
          d.writeUint8(parseInt(a.substring(e, e + 2), 16));
        return d.flip();
      };
      c.encodeBinary = function(a) {
        ...
        var b = [],
            d = a.view,
            e = a.offset;
        for (a = a.length; e < a; ++e)
          b.push(String.fromCharCode(d.getUint8(e)));
        return b.join("");
      };
      c.decodeBinary = function(a, b) {
        ...
        for (var d = a.length,
            ...
            g,
            k = 0; k < d; ++k) {
          if (255 < (g = a.charCodeAt(k)))
            throw Error("Illegal argument: Not a binary string (char code " + g + ")");
          f.setUint8(k, g);
        }
        g = new c(d, b, !0);
        g.array = e;
      ...
      c.prototype.writeUTF8String = function(a, b) {
        ...
        for (var f = 0,
            g = a.length; f < g; ++f)
          b += c.encodeUTF8Char(a.charCodeAt(f), this, b);
      ...
      c.prototype.readUTF8String = function(a, b) {
        ...
        for (var e,
            ...
            g = b,
            k = 0; k < a; ++k)
          e = c.decodeUTF8Char(this, b), b += e.length, f += String.fromCharCode(e["char"]);
      ...
      c.prototype.readUTF8StringBytes = function(a, b) {
        ...
        for (a = b + a; b < a; )
          e = c.decodeUTF8Char(this, b), b += e.length, f += String.fromCharCode(e["char"]);
        if (b != a)
          throw Error("Actual string length differs from the specified: " + ((b > a ? "+" : "") + b - a) + " bytes");
        return d ? (this.offset = b, f) : {
          string: f,
          length: b - g
        };
      ...
      c.prototype.readCString = function(a) {
        ...
        var d,
            ...
            f = a;
        do
          d = c.decodeUTF8Char(this, a), a += d.length, 0 != d["char"] && (e += String.fromCharCode(d["char"]));
 while (0 != d["char"]);
      ...
      c.prototype.writeJSON = function(a, b, c) {
        ...
        return this.writeLString(c(a), b);
      };
      ...
      c.prototype.toColumns = function(a) {
        ...
        for (k = c.length; g < k; ++g)
          for (; c[g].length < 3 * a + 1; )
            c[g] += "   ";
        for (var h = 0,
            b = "",
            g = 0,
            k = this.array.byteLength; g < k; ++g)
          0 < g && 0 == g % a && (c[h] += " " + b, b = "", h++), e = f.getUint8(g), b += 32 < e && 127 > e ? String.fromCharCode(e) : ".";
        "" != b && (c[h] += " " + b);
        return c.join("\n");
      };
      ...
      c.prototype.toHex = function(a) {
        ...
        if (a) {
          ...
          b = 0 == this.offset && 0 == this.length ? b + "|" : 0 == this.length ? b + ">" : 0 == this.offset ? b + "<" : b + " ";
          e = 0;
          for (f = this.array.byteLength; e < f; ++e)
            a = d.getUint8(e).toString(16).toUpperCase(), 2 > a.length && (a = "0" + a), b += a, b = e + 1 === this.offset && e + 1 === this.length ? b + "|" : e + 1 == this.offset ? b + "<" : e + 1 == this.length ? b + ">" : b + " ";
          return b;
        }
      ...
      c.prototype.toArrayBuffer = function(a) {
        ...
        var c = !1;
        if (0 < b.offset || b.length < b.array.byteLength)
          b.compact(), c = !0;
