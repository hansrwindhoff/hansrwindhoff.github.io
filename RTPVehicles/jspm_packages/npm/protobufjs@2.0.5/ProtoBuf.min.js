    ...
    function s(p) {
      ...
      g.Util = function() {
        ...
        c.fetch = function(b, l) {
          ...
          if (c.IS_NODE)
            if (l)
              require("fs").readFile(b, function(a, b) {
                a ? l(null) : l("" + b);
              });
            else
              try {
        ...
        c.isArray = function(b) {
          return b ? b instanceof Array ? !0 : Array.isArray ? Array.isArray(b) : "[object Array]" === Object.prototype.toString.call(b) : !1;
        };
        return c;
      }();
      g.Lang = {
      ...
      g.DotProto.Tokenizer = function(c) {
        ...
        b.prototype._readString = function() {
          ...
          var b;
          if (null !== (b = c.STRING.exec(this.source)))
            return b = b[1], this.index = c.STRING.lastIndex, this.stack.push(c.STRINGCLOSE), b;
        ...
        b.prototype.next = function() {
          ...
          do {
            for (b = !1; c.WHITESPACE.test(k = this.source.charAt(this.index)); )
              if (this.index++, "\n" === k && this.line++, this.index === this.source.length)
                return null;
            if ("/" === this.source.charAt(this.index))
              if ("/" === this.source.charAt(++this.index)) {
                ...
                for (k = ""; "*/" !== k + (k = this.source.charAt(this.index)); )
                  if (this.index++, "\n" === k && this.line++, this.index === this.source.length)
                    return null;
                this.index++;
                b = !0;
          ...
          b = this.index;
          c.DELIM.lastIndex = 0;
          if (c.DELIM.test(this.source.charAt(b)))
            b++;
          else
            for (b++; b < this.source.length && !c.DELIM.test(this.source.charAt(b)); )
              b++;
      ...
      g.DotProto.Parser = function(c, b, g) {
        ...
        c.prototype.parse = function() {
          ...
          do {
            ...
            if ("package" == a) {
              ...
              this._parseMessage(b, a), d = !1;
            else if ("enum" === a)
              this._parseEnum(b, a), d = !1;
            else if ("option" === a) {
              if (!d)
              ...
              this._parseService(b, a);
            else if ("extend" === a)
              this._parseExtend(b, a);
            else if ("syntax" === a)
              this._parseIgnoredStatement(b, a);
            else
              throw Error("Illegal top level declaration at line " + this.tn.line + ": " + a);
          } while (1);
          delete b.name;
          return b;
        };
        c.prototype._parseNumber = function(c) {
          ...
          if (b.NUMBER_DEC.test(c))
            return a * parseInt(c, 10);
          if (b.NUMBER_HEX.test(c))
            return a * parseInt(c.substring(2), 16);
          if (b.NUMBER_OCT.test(c))
            return a * parseInt(c.substring(1), 8);
          if (b.NUMBER_FLT.test(c))
        ...
        c.prototype._parseId = function(c, a) {
          ...
          if (b.NUMBER_DEC.test(c))
            d = parseInt(c);
          else if (b.NUMBER_HEX.test(c))
            d = parseInt(c.substring(2), 16);
          else if (b.NUMBER_OCT.test(c))
            d = parseInt(c.substring(1), 8);
          else
            throw Error("Illegal ID value at line " + this.tn.line + ": " + (0 > e ? "-" : "") + c);
          d = e * d | 0;
          if (!a && 0 > d)
            throw Error("Illegal ID range at line " + this.tn.line + ": " + (0 > e ? "-" : "") + c);
          return d;
        };
        c.prototype._parsePackage = function(c) {
          c = this.tn.next();
          if (!b.TYPEREF.test(c))
            throw Error("Illegal package name at line " + this.tn.line + ": " + c);
          var a = c;
          c = this.tn.next();
          if (c != b.END)
            throw Error("Illegal end of package definition at line " + this.tn.line + ": " + c + " ('" + b.END + "' expected)");
          return a;
        };
        c.prototype._parseImport = function(c) {
          ...
          if (c !== b.STRINGOPEN)
            throw Error("Illegal begin of import value at line " + this.tn.line + ": " + c + " ('" + b.STRINGOPEN + "' expected)");
          var a = this.tn.next();
          c = this.tn.next();
          if (c !== b.STRINGCLOSE)
            throw Error("Illegal end of import value at line " + this.tn.line + ": " + c + " ('" + b.STRINGCLOSE + "' expected)");
          c = this.tn.next();
          if (c !== b.END)
            throw Error("Illegal end of import definition at line " + this.tn.line + ": " + c + " ('" + b.END + "' expected)");
          return a;
        };
        c.prototype._parseOption = function(c, a) {
          ...
          if (!b.NAME.test(a) && !/google\.protobuf\./.test(a))
            throw Error("Illegal option name in message " + c.name + " at line " + this.tn.line + ": " + a);
          var e = a;
          a = this.tn.next();
          if (d) {
            if (a !== b.COPTCLOSE)
              throw Error("Illegal custom option name delimiter in message " + c.name + ", option " + e + " at line " + this.tn.line + ": " + a + " ('" + b.COPTCLOSE + "' expected)");
            e = "(" + e + ")";
            a = this.tn.next();
            b.FQTYPEREF.test(a) && (e += a, a = this.tn.next());
          }
          if (a !== b.EQUAL)
            throw Error("Illegal option operator in message " + c.name + ", option " + e + " at line " + this.tn.line + ": " + a + " ('" + b.EQUAL + "' expected)");
          a = this.tn.next();
          if (a === b.STRINGOPEN) {
            if (d = this.tn.next(), a = this.tn.next(), a !== b.STRINGCLOSE)
              throw Error("Illegal end of option value in message " + c.name + ", option " + e + " at line " + this.tn.line + ": " + a + " ('" + b.STRINGCLOSE + "' expected)");
          } else if (b.NUMBER.test(a))
            d = this._parseNumber(a, !0);
          else if (b.TYPEREF.test(a))
            d = a;
          else
            throw Error("Illegal option value in message " + c.name + ", option " + e + " at line " + this.tn.line + ": " + a);
          a = this.tn.next();
          if (a !== b.END)
            throw Error("Illegal end of option in message " + c.name + ", option " + e + " at line " + this.tn.line + ": " + a + " ('" + b.END + "' expected)");
          c.options[e] = d;
        };
        c.prototype._parseIgnoredBlock = function(c, a) {
          var d = this.tn.next();
          if (!b.TYPEREF.test(d))
            throw Error("Illegal " + a + " type in " + c.name + ": " + d);
          var e = d,
              d = this.tn.next();
          if (d !== b.OPEN)
            throw Error("Illegal OPEN in " + c.name + " after " + a + " " + e + " at line " + this.tn.line + ": " + d);
          var h = 1;
          do {
            d = this.tn.next();
            if (null === d)
              throw Error("Unexpected EOF in " + c.name + ", " + a + " (ignored) at line " + this.tn.line + ": " + e);
            if (d === b.OPEN)
              h++;
            else if (d === b.CLOSE && (d = this.tn.peek(), d === b.END && this.tn.next(), h--, 0 === h))
              break;
          } while (1);
        };
        c.prototype._parseIgnoredStatement = function(c, a) {
          ...
          do {
            d = this.tn.next();
            if (null === d)
              throw Error("Unexpected EOF in " + c.name + ", " + a + " (ignored) at line " + this.tn.line);
            if (d === b.END)
              break;
          } while (1);
        };
        c.prototype._parseService = function(c, a) {
          var d = this.tn.next();
          if (!b.NAME.test(d))
            throw Error("Illegal service name at line " + this.tn.line + ": " + d);
          var e = d,
              h = {
                name: e,
                rpc: {},
              ...
              d = this.tn.next();
          if (d !== b.OPEN)
            throw Error("Illegal OPEN after service " + e + " at line " + this.tn.line + ": " + d + " ('" + b.OPEN + "' expected)");
          do
            if (d = this.tn.next(), "option" === d)
              this._parseOption(h, d);
            else if ("rpc" === d)
              this._parseServiceRPC(h, d);
            else if (d !== b.CLOSE)
              throw Error("Illegal type for service " + e + " at line " + this.tn.line + ": " + d);
 while (d !== b.CLOSE);
          c.services.push(h);
        };
        c.prototype._parseServiceRPC = function(c, a) {
          ...
          a = this.tn.next();
          if (!b.NAME.test(a))
            throw Error("Illegal RPC method name in service " + c.name + " at line " + this.tn.line + ": " + a);
          var e = a,
              h = {
                request: null,
                response: null,
          ...
          a = this.tn.next();
          if (a !== b.COPTOPEN)
            throw Error("Illegal start of request type in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a + " ('" + b.COPTOPEN + "' expected)");
          a = this.tn.next();
          if (!b.TYPEREF.test(a))
            throw Error("Illegal request type in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a);
          h.request = a;
          a = this.tn.next();
          if (a != b.COPTCLOSE)
            throw Error("Illegal end of request type in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a + " ('" + b.COPTCLOSE + "' expected)");
          a = this.tn.next();
          if ("returns" !== a.toLowerCase())
            throw Error("Illegal request/response delimiter in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a + " ('returns' expected)");
          a = this.tn.next();
          if (a != b.COPTOPEN)
            throw Error("Illegal start of response type in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a + " ('" + b.COPTOPEN + "' expected)");
          a = this.tn.next();
          h.response = a;
          a = this.tn.next();
          if (a !== b.COPTCLOSE)
            throw Error("Illegal end of response type in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a + " ('" + b.COPTCLOSE + "' expected)");
          a = this.tn.next();
          if (a === b.OPEN) {
            do
              if (a = this.tn.next(), "option" === a)
                this._parseOption(h, a);
              else if (a !== b.CLOSE)
                throw Error("Illegal start of option in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a + " ('option' expected)");
 while (a !== b.CLOSE);
          } else if (a !== b.END)
            throw Error("Illegal method delimiter in RPC service " + c.name + "#" + e + " at line " + this.tn.line + ": " + a + " ('" + b.END + "' or '" + b.OPEN + "' expected)");
        ...
        c.prototype._parseMessage = function(c, a) {
          ...
          a = this.tn.next();
          if (!b.NAME.test(a))
            throw Error("Illegal message name" + (c ? " in message " + c.name : "") + " at line " + this.tn.line + ": " + a);
          d.name = a;
          a = this.tn.next();
          if (a != b.OPEN)
            throw Error("Illegal OPEN after message " + d.name + " at line " + this.tn.line + ": " + a + " ('" + b.OPEN + "' expected)");
          d.fields = [];
          d.enums = [];
          d.messages = [];
          d.options = {};
          do
            if (a = this.tn.next(), a === b.CLOSE) {
              ...
              break;
            } else if (b.RULE.test(a))
              this._parseMessageField(d, a);
            else if ("enum" === a)
              this._parseEnum(d, a);
            else if ("message" === a)
              this._parseMessage(d, a);
            else if ("option" === a)
              this._parseOption(d, a);
            else if ("extensions" === a)
              d.extensions = this._parseExtensions(d, a);
            else if ("extend" === a)
              this._parseExtend(d, a);
            else
              throw Error("Illegal token in message " + d.name + " at line " + this.tn.line + ": " + a + " (type or '" + b.CLOSE + "' expected)");
 while (1);
          c.messages.push(d);
          return d;
        };
        c.prototype._parseMessageField = function(c, a) {
          ...
          d.rule = a;
          a = this.tn.next();
          if (!b.TYPE.test(a) && !b.TYPEREF.test(a))
            throw Error("Illegal field type in message " + c.name + " at line " + this.tn.line + ": " + a);
          d.type = a;
          a = this.tn.next();
          if (!b.NAME.test(a))
            throw Error("Illegal field name in message " + c.name + " at line " + this.tn.line + ": " + a);
          d.name = a;
          a = this.tn.next();
          if (a !== b.EQUAL)
            throw Error("Illegal field number operator in message " + c.name + "#" + d.name + " at line " + this.tn.line + ": " + a + " ('" + b.EQUAL + "' expected)");
          a = this.tn.next();
          try {
          ...
          if (a !== b.END)
            throw Error("Illegal field delimiter in message " + c.name + "#" + d.name + " at line " + this.tn.line + ": " + a + " ('" + b.END + "' expected)");
          c.fields.push(d);
        };
        c.prototype._parseFieldOptions = function(c, a, d) {
          ...
          do {
            ...
            if (d === b.OPTCLOSE)
              ...
              if (e)
                throw Error("Illegal start of message field options in message " + c.name + "#" + a.name + " at line " + this.tn.line + ": " + d);
              d = this.tn.next();
            }
        ...
        c.prototype._parseFieldOption = function(c, a, d) {
          ...
          if (!b.NAME.test(d))
            throw Error("Illegal field option in message " + c.name + "#" + a.name + " at line " + this.tn.line + ": " + d);
          var h = d;
          d = this.tn.next();
          if (e) {
            if (d !== b.COPTCLOSE)
              throw Error("Illegal custom field option name delimiter in message " + c.name + "#" + a.name + " at line " + this.tn.line + ": " + d + " (')' expected)");
            h = "(" + h + ")";
            d = this.tn.next();
            b.FQTYPEREF.test(d) && (h += d, d = this.tn.next());
          }
          if (d !== b.EQUAL)
            throw Error("Illegal field option operation in message " + c.name + "#" + a.name + " at line " + this.tn.line + ": " + d + " ('=' expected)");
          d = this.tn.next();
          if (d === b.STRINGOPEN) {
            if (e = this.tn.next(), d = this.tn.next(), d != b.STRINGCLOSE)
              throw Error("Illegal end of field value in message " + c.name + "#" + a.name + ", option " + h + " at line " + this.tn.line + ": " + d + " ('" + b.STRINGCLOSE + "' expected)");
          } else if (b.NUMBER.test(d, !0))
            e = this._parseNumber(d, !0);
          else if (b.BOOL.test(d))
            e = "true" === d.toLowerCase();
          else if (b.TYPEREF.test(d))
            e = d;
          else
            throw Error("Illegal field option value in message " + c.name + "#" + a.name + ", option " + h + " at line " + this.tn.line + ": " + d);
          a.options[h] = e;
        };
        c.prototype._parseEnum = function(c, a) {
          ...
          a = this.tn.next();
          if (!b.NAME.test(a))
            throw Error("Illegal enum name in message " + c.name + " at line " + this.tn.line + ": " + a);
          d.name = a;
          a = this.tn.next();
          if (a !== b.OPEN)
            throw Error("Illegal OPEN after enum " + d.name + " at line " + this.tn.line + ": " + a);
          d.values = [];
          d.options = {};
          do {
            a = this.tn.next();
            ...
            if ("option" == a)
              ...
              if (!b.NAME.test(a))
                throw Error("Illegal enum value name in enum " + d.name + " at line " + this.tn.line + ": " + a);
        ...
        c.prototype._parseEnumValue = function(c, a) {
          ...
          a = this.tn.next();
          if (a !== b.EQUAL)
            throw Error("Illegal enum value operator in enum " + c.name + " at line " + this.tn.line + ": " + a + " ('" + b.EQUAL + "' expected)");
          a = this.tn.next();
          try {
          ...
          c.values.push(d);
          a = this.tn.next();
          a === b.OPTOPEN && (this._parseFieldOptions(c, {options: {}}, a), a = this.tn.next());
          if (a !== b.END)
            throw Error("Illegal enum value delimiter in enum " + c.name + " at line " + this.tn.line + ": " + a + " ('" + b.END + "' expected)");
        };
        c.prototype._parseExtensions = function(c, a) {
          ...
          a = this.tn.next();
          if ("to" !== a)
            throw "Illegal extensions delimiter in message " + c.name + " at line " + this.tn.line + " ('to' expected)";
          a = this.tn.next();
          "min" === a ? d.push(b.ID_MIN) : "max" === a ? d.push(b.ID_MAX) : d.push(this._parseNumber(a));
          a = this.tn.next();
          if (a !== b.END)
            throw Error("Illegal extension delimiter in message " + c.name + " at line " + this.tn.line + ": " + a + " ('" + b.END + "' expected)");
          return d;
        };
        c.prototype._parseExtend = function(c, a) {
          a = this.tn.next();
          if (!b.TYPEREF.test(a))
            throw Error("Illegal extended message name at line " + this.tn.line + ": " + a);
          var d = {};
          d.ref = a;
          d.fields = [];
          a = this.tn.next();
          if (a !== b.OPEN)
            throw Error("Illegal OPEN in extend " + d.name + " at line " + this.tn.line + ": " + a + " ('" + b.OPEN + "' expected)");
          do
            if (a = this.tn.next(), a === b.CLOSE) {
              a = this.tn.peek();
              a == b.END && this.tn.next();
              ...
              throw Error("Illegal token in extend " + d.name + " at line " + this.tn.line + ": " + a + " (rule or '" + b.CLOSE + "' expected)");
 while (1);
          c.messages.push(d);
          return d;
        };
      ...
      g.Reflect = function(c) {
        ...
        k.prototype.getChildren = function(a) {
          ...
          for (var c = [],
            ...
            this.children[b] instanceof a && c.push(this.children[b]);
          return c;
        };
        k.prototype.addChild = function(c) {
          var b;
          if (b = this.getChild(c.name))
            if (b instanceof a.Field && b.name !== b.originalName && !this.hasChild(b.originalName))
              b.name = b.originalName;
            else if (c instanceof a.Field && c.name !== c.originalName && !this.hasChild(c.originalName))
              c.name = c.originalName;
            else
              throw Error("Duplicate name in namespace " + this.toString(!0) + ": " + c.name);
        ...
        k.prototype.hasChild = function(a) {
          ...
          if ("number" == typeof a)
            for (c = 0; c < this.children.length; c++) {
              if ("undefined" !== typeof this.children[c].id && this.children[c].id == a)
                return !0;
            }
          else
            for (c = 0; c < this.children.length; c++)
              if ("undefined" !== typeof this.children[c].name && this.children[c].name == a)
                return !0;
          return !1;
        };
        k.prototype.getChild = function(a) {
          var c;
          if ("number" == typeof a)
            for (c = 0; c < this.children.length; c++) {
              if ("undefined" !== typeof this.children[c].id && this.children[c].id == a)
        ...
        k.prototype.resolve = function(a, c) {
          ...
          do {
            ...
            if (null != e)
              break;
            if (null !== this.parent)
              return this.parent.resolve(a, c);
          } while (null != e);
          return e;
        };
        k.prototype.build = function() {
          for (var a = {},
              ...
              b,
              d = 0; d < c.length; d++)
            b = c[d], b instanceof k && (a[b.name] = b.build());
        ...
        a.prototype.build = function(d) {
          ...
          d = function(a, c) {
            var d = c.getChildren(b.Message.Field),
                f = function(c) {
                  ...
                  for (b = 0; b < d.length; b++)
                    f = d[b], this[f.name] = f.repeated ? [] : null;
                  for (b = 0; b < d.length; b++)
                    if (f = d[b], "undefined" != typeof f.options["default"])
                      try {
                  ...
                  if (1 != arguments.length || "object" != typeof c || "function" == typeof c.encode || a.Util.isArray(c) || c instanceof p || c instanceof ArrayBuffer || a.Long && c instanceof a.Long)
                    for (b = 0; b < arguments.length; b++)
                      b < d.length && this.set(d[b].name, arguments[b]);
                  else
                    for (f = Object.keys(c), b = 0; b < f.length; b++)
                      this.set(f[b], c[f[b]]);
                };
            ...
            f.prototype.add = function(b, d) {
              var f = c.getChild(b);
              if (!f)
                throw Error(this + "#" + b + " is undefined");
              if (!(f instanceof a.Reflect.Message.Field))
                throw Error(this + "#" + b + " is not a field: " + f.toString(!0));
              if (!f.repeated)
                throw Error(this + "#" + b + " is not a repeated field");
            ...
            f.prototype.set = function(b, d) {
              var f = c.getChild(b);
              if (!f)
                throw Error(this + "#" + b + " is not a field: undefined");
              if (!(f instanceof a.Reflect.Message.Field))
                throw Error(this + "#" + b + " is not a field: " + f.toString(!0));
            ...
            f.prototype.get = function(b) {
              ...
              if (!(d instanceof a.Reflect.Message.Field))
                throw Error(this + "#" + b + " is not a field: " + d.toString(!0));
              return this[d.name];
            };
            ...
            f.prototype.toBase64 = f.prototype.encode64;
          ...
          for (var m = this.getChildren(),
              q = 0; q < m.length; q++)
            if (m[q] instanceof e)
              d[m[q].name] = m[q].build();
            else if (m[q] instanceof a)
              d[m[q].name] = m[q].build();
            else if (!(m[q] instanceof a.Field))
              throw Error("Illegal reflect child of " + this.toString(!0) + ": " + m[q].toString(!0));
          return this.clazz = d;
        };
        a.prototype.encode = function(c, b) {
          for (var d = this.getChildren(a.Field),
              e = null,
              h = 0; h < d.length; h++) {
          ...
          if (null !== e)
            throw d = Error("Missing at least one required field for " + this.toString(!0) + ": " + e), d.encoded = b, d;
          return b;
        };
        a.prototype.decode = function(a, b) {
          b = "number" === typeof b ? b : -1;
          for (var d = a.offset,
              e = new this.clazz; a.offset < d + b || -1 == b && 0 < a.remaining(); ) {
            var h = a.readVarint32(),
                g = h & 7,
                h = h >> 3,
                k = this.getChild(h);
            if (k)
              k.repeated && !k.options.packed ? e.add(k.name, k.decode(g, a)) : e.set(k.name, k.decode(g, a));
            else
              switch (g) {
          ...
          for (g = 0; g < d.length; g++)
            if (d[g].required && null === e[d[g].name])
              throw d = Error("Missing at least one required field for " + this.toString(!0) + ": " + d[g].name), d.decoded = e, d;
          return e;
        };
        b.Message = a;
        ...
        d.prototype.verifyValue = function(a, b) {
          ...
          if (null === a) {
            if (this.required)
              throw Error("Illegal value for " + this.toString(!0) + ": " + a + " (required)");
            return null;
          }
          var d;
          if (this.repeated && !b) {
            ...
            for (d = 0; d < a.length; d++)
              h.push(this.verifyValue(a[d], !0));
            return h;
          }
          if (!this.repeated && c.Util.isArray(a))
            throw Error("Illegal value for " + this.toString(!0) + ": " + a + " (no array expected)");
          if (this.type == c.TYPES.int32 || this.type == c.TYPES.sint32 || this.type == c.TYPES.sfixed32)
            return isNaN(d = parseInt(a, 10)) ? d : d | 0;
          if (this.type == c.TYPES.uint32 || this.type == c.TYPES.fixed32)
            return isNaN(d = parseInt(a, 10)) ? d : d >>> 0;
          if (c.Long) {
            if (this.type == c.TYPES.int64 || this.type == c.TYPES.sint64 || this.type == c.TYPES.sfixed64)
              return "object" == typeof a && a instanceof c.Long ? a.unsigned ? a.toSigned() : a : c.Long.fromNumber(a, !1);
            if (this.type == c.TYPES.uint64 || this.type == c.TYPES.fixed64)
              return "object" == typeof a && a instanceof c.Long ? a.unsigned ? a : a.toUnsigned() : c.Long.fromNumber(a, !0);
          }
          if (this.type == c.TYPES.bool)
            return "string" === typeof a ? "true" === a : !!a;
          if (this.type == c.TYPES["float"] || this.type == c.TYPES["double"])
            return parseFloat(a);
          if (this.type == c.TYPES.string)
            return "" + a;
          if (this.type == c.TYPES.bytes)
            return a && a instanceof p ? a : p.wrap(a);
          if (this.type == c.TYPES["enum"]) {
            h = this.resolvedType.getChildren(e.Value);
            for (d = 0; d < h.length; d++)
              if (h[d].name == a || h[d].id == a)
                return h[d].id;
            throw Error("Illegal value for " + this.toString(!0) + ": " + a + " (not a valid enum value)");
          }
          if (this.type == c.TYPES.message) {
            if ("object" !== typeof a)
              throw Error("Illegal value for " + this.toString(!0) + ": " + a + " (object expected)");
            return a instanceof this.resolvedType.clazz ? a : new this.resolvedType.clazz(a);
          }
        ...
        d.prototype.encodeValue = function(a, b) {
          if (null !== a) {
            if (this.type == c.TYPES.int32 || this.type == c.TYPES.uint32)
              b.writeVarint32(a);
            else if (this.type == c.TYPES.sint32)
              b.writeZigZagVarint32(a);
            else if (this.type == c.TYPES.fixed32)
              b.writeUint32(a);
            else if (this.type == c.TYPES.sfixed32)
              b.writeInt32(a);
            else if (this.type == c.TYPES.int64 || this.type == c.TYPES.uint64)
              b.writeVarint64(a);
            else if (this.type == c.TYPES.sint64)
              b.writeZigZagVarint64(a);
            else if (this.type == c.TYPES.fixed64)
              b.writeUint64(a);
            else if (this.type == c.TYPES.sfixed64)
              b.writeInt64(a);
            else if (this.type == c.TYPES.bool)
              "string" === typeof a ? b.writeVarint32("false" === a.toLowerCase() ? 0 : !!a) : b.writeVarint32(a ? 1 : 0);
            else if (this.type == c.TYPES["enum"])
              b.writeVarint32(a);
            else if (this.type == c.TYPES["float"])
              b.writeFloat32(a);
            else if (this.type == c.TYPES["double"])
              b.writeFloat64(a);
            else if (this.type == c.TYPES.string)
              b.writeVString(a);
            else if (this.type == c.TYPES.bytes)
              a.offset > a.length && (b = b.clone().flip()), b.writeVarint32(a.remaining()), b.append(a);
        ...
        d.prototype.decode = function(a, b, d) {
          ...
          if (this.type == c.TYPES.int32)
            return b.readVarint32() | 0;
          if (this.type == c.TYPES.uint32)
            return b.readVarint32() >>> 0;
          if (this.type == c.TYPES.sint32)
            return b.readZigZagVarint32() | 0;
          if (this.type == c.TYPES.fixed32)
            return b.readUint32() >>> 0;
          if (this.type == c.TYPES.sfixed32)
            return b.readInt32() | 0;
          if (this.type == c.TYPES.int64)
            return b.readVarint64();
          if (this.type == c.TYPES.uint64)
            return b.readVarint64().toUnsigned();
          if (this.type == c.TYPES.sint64)
            return b.readZigZagVarint64();
          if (this.type == c.TYPES.fixed64)
            return b.readUint64();
          if (this.type == c.TYPES.sfixed64)
            return b.readInt64();
          if (this.type == c.TYPES.bool)
            return !!b.readVarint32();
          if (this.type == c.TYPES["enum"])
            return b.readVarint32();
          if (this.type == c.TYPES["float"])
            return b.readFloat();
          if (this.type == c.TYPES["double"])
            return b.readDouble();
          if (this.type == c.TYPES.string)
        ...
        h.prototype.build = function(a) {
          return this.clazz && !a ? this.clazz : this.clazz = function(a, c) {
            ...
            for (var e = c.getChildren(b.Service.RPCMethod),
                f = 0; f < e.length; f++)
              (function(a) {
                d.prototype[a.name] = function(b, d) {
                  try {
                    b && b instanceof a.resolvedRequestType.clazz || setTimeout(d.bind(this, Error("Illegal request type provided to service method " + c.name + "#" + a.name))), this.rpcImpl(a.fqn(), b, function(b, e) {
                      if (b)
                        d(b);
                      else {
                        try {
                ...
                Object.defineProperty && (Object.defineProperty(d[a.name], "$options", {
                  ...
                  configurable: !1,
                  writable: !1
                }), Object.defineProperty(d.prototype[a.name], "$options", {
      ...
      g.Builder = function(c, b, g) {
        ...
        k.prototype.define = function(a, c) {
          ...
          for (h = 0; h < e.length; h++)
            if (!b.NAME.test(e[h]))
              throw Error("Illegal package name: " + e[h]);
          for (h = 0; h < e.length; h++)
            this.ptr.hasChild(e[h]) || this.ptr.addChild(new g.Namespace(this.ptr, e[h], c)), this.ptr = this.ptr.getChild(e[h]);
          return this;
        };
        k.isValidMessage = function(a) {
          if ("string" !== typeof a.name || !b.NAME.test(a.name) || "undefined" !== typeof a.values || "undefined" !== typeof a.rpc)
            return !1;
          var d;
          if ("undefined" !== typeof a.fields) {
            if (!c.Util.isArray(a.fields))
              return !1;
            var e = [],
                h;
            for (d = 0; d < a.fields.length; d++) {
              if (!k.isValidMessageField(a.fields[d]))
                return !1;
              h = parseInt(a.id, 10);
              if (0 <= e.indexOf(h))
                return !1;
          ...
          if ("undefined" !== typeof a.enums) {
            if (!c.Util.isArray(a.enums))
              return !1;
            for (d = 0; d < a.enums.length; d++)
              if (!k.isValidEnum(a.enums[d]))
                return !1;
          }
          if ("undefined" !== typeof a.messages) {
            if (!c.Util.isArray(a.messages))
              return !1;
            for (d = 0; d < a.messages.length; d++)
              if (!k.isValidMessage(a.messages[d]) && !k.isValidExtend(a.messages[d]))
                return !1;
          }
        ...
        k.isValidMessageField = function(a) {
          if ("string" !== typeof a.rule || "string" !== typeof a.name || "string" !== typeof a.type || "undefined" === typeof a.id || !(b.RULE.test(a.rule) && b.NAME.test(a.name) && b.TYPEREF.test(a.type) && b.ID.test("" + a.id)))
            return !1;
          if ("undefined" != typeof a.options) {
            if ("object" != typeof a.options)
              return !1;
            for (var c = Object.keys(a.options),
                e = 0; e < c.length; e++)
              if (!b.OPTNAME.test(c[e]) || "string" !== typeof a.options[c[e]] && "number" !== typeof a.options[c[e]] && "boolean" !== typeof a.options[c[e]])
                return !1;
          }
          return !0;
        };
        k.isValidEnum = function(a) {
          if ("string" !== typeof a.name || !b.NAME.test(a.name) || "undefined" === typeof a.values || !c.Util.isArray(a.values) || 0 == a.values.length)
            return !1;
          for (var d = 0; d < a.values.length; d++)
            if ("object" != typeof a.values[d] || "string" !== typeof a.values[d].name || "undefined" === typeof a.values[d].id || !b.NAME.test(a.values[d].name) || !b.NEGID.test("" + a.values[d].id))
              return !1;
          return !0;
        };
              ...
              if (c.Util.isArray(a))
                for (; 0 < a.length; )
                  if (e = a.shift(), k.isValidMessage(e)) {
                    h = new g.Message(this.ptr, e.name, e.options);
                    if (e.fields && 0 < e.fields.length)
                      for (f = 0; f < e.fields.length; f++) {
                        if (h.hasChild(e.fields[f].id))
                          throw Error("Duplicate field id in message " + h.name + ": " + e.fields[f].id);
                        if (e.fields[f].options)
                          for (n = Object.keys(e.fields[f].options), m = 0; m < n.length; m++) {
                            if (!b.OPTNAME.test(n[m]))
                              throw Error("Illegal field option name in message " + h.name + "#" + e.fields[f].name + ": " + n[m]);
                            if ("string" !== typeof e.fields[f].options[n[m]] && "number" !== typeof e.fields[f].options[n[m]] && "boolean" !== typeof e.fields[f].options[n[m]])
                              throw Error("Illegal field option value in message " + h.name + "#" + e.fields[f].name + "#" + n[m] + ": " + e.fields[f].options[n[m]]);
                          }
                    ...
                    if ("undefined" !== typeof e.enums && 0 < e.enums.length)
                      for (f = 0; f < e.enums.length; f++)
                        n.push(e.enums[f]);
                    if (e.messages && 0 < e.messages.length)
                      for (f = 0; f < e.messages.length; f++)
                        n.push(e.messages[f]);
                    e.extensions && (h.extensions = e.extensions, h.extensions[0] < c.Lang.ID_MIN && (h.extensions[0] = c.Lang.ID_MIN), h.extensions[1] > c.Lang.ID_MAX && (h.extensions[1] = c.Lang.ID_MAX));
                    this.ptr.addChild(h);
                    ...
                    for (f = 0; f < e.values.length; f++)
                      h.addChild(new g.Enum.Value(h, e.values[f].name, e.values[f].id));
                    this.ptr.addChild(h);
                  } else if (k.isValidService(e)) {
                    h = new g.Service(this.ptr, e.name, e.options);
                    for (f in e.rpc)
                      e.rpc.hasOwnProperty(f) && h.addChild(new g.Service.RPCMethod(h, f, e.rpc[f].request, e.rpc[f].response, e.rpc[f].options));
                    this.ptr.addChild(h);
                  } else if (k.isValidExtend(e))
                    if (h = this.ptr.resolve(e.ref))
                      for (f = 0; f < e.fields.length; f++) {
                        if (h.hasChild(e.fields[f].id))
                          throw Error("Duplicate extended field id in message " + h.name + ": " + e.fields[f].id);
                        if (e.fields[f].id < h.extensions[0] || e.fields[f].id > h.extensions[1])
                          throw Error("Illegal extended field id in message " + h.name + ": " + e.fields[f].id + " (" + h.extensions.join(" to ") + " expected)");
                        h.addChild(new g.Message.Field(h, e.fields[f].rule, e.fields[f].type, e.fields[f].name, e.fields[f].id, e.fields[f].options));
                      }
                    else {
                      if (!/\.?google\.protobuf\./.test(e.ref))
                        throw Error("Extended message " + e.ref + " is not defined");
                    }
                  else
                    throw Error("Not a valid message, enum, service or extend definition: " + JSON.stringify(e));
              else
                throw Error("Not a valid namespace definition: " + JSON.stringify(a));
        ...
        k.prototype["import"] = function(a, b) {
          if ("string" === typeof b) {
          ...
          if (a.imports && 0 < a.imports.length) {
            var e,
                ...
                g = !1;
            if ("object" === typeof b) {
              if (this.importRoot = b.root, g = !0, e = this.importRoot, b = b.file, 0 <= e.indexOf("\\") || 0 <= b.indexOf("\\"))
                h = "\\";
            } else
              "string" === typeof b ? this.importRoot ? e = this.importRoot : 0 <= b.indexOf("/") ? (e = b.replace(/\/[^\/]*$/, ""), "" === e && (e = "/")) : 0 <= b.indexOf("\\") ? (e = b.replace(/\\[^\\]*$/, ""), h = "\\") : e = "." : e = null;
            for (var f = 0; f < a.imports.length; f++)
              if ("string" === typeof a.imports[f]) {
                ...
                if (k.isValidImport(m)) {
                  ...
                  if (null === l)
                    throw Error("Failed to import '" + m + "' in '" + b + "': File not found");
                  if (/\.json$/i.test(m))
                    this["import"](JSON.parse(l + ""), m);
                  else
                    this["import"]((new c.DotProto.Parser(l + "")).parse(), m);
                }
              } else if (b)
                if (/\.(\w+)$/.test(b))
                  this["import"](a.imports[f], b.replace(/^(.+)\.(\w+)$/, function(a, b, c) {
                    return b + "_import" + f + "." + c;
                  }));
                else
                  this["import"](a.imports[f], b + "_import" + f);
              else
          ...
          a["extends"] && (a["package"] && this.define(a["package"], a.options), this.create(a["extends"]), this.reset());
          return this;
        };
        ...
        k.isValidExtend = function(a) {
          if ("string" !== typeof a.ref || !b.TYPEREF.test(a.name))
            return !1;
          var d;
          if ("undefined" !== typeof a.fields) {
            if (!c.Util.isArray(a.fields))
          ...
          if (null != this.ptr && "object" !== typeof this.ptr.type) {
            if (this.ptr instanceof g.Namespace) {
              ...
              if (b.TYPE.test(this.ptr.type))
                ...
                if (a instanceof g.Enum)
                  this.ptr.type = c.TYPES["enum"];
                else if (a instanceof g.Message)
                  this.ptr.type = c.TYPES.message;
                else
                  throw Error("Illegal type reference in " + this.ptr.toString(!0) + ": " + this.ptr.type);
              }
              ...
              if (this.ptr instanceof c.Reflect.Service.Method)
                if (this.ptr instanceof c.Reflect.Service.RPCMethod) {
                  ...
                  if (!(a && a instanceof c.Reflect.Message))
                    throw Error("Illegal request type reference in " + this.ptr.toString(!0) + ": " + this.ptr.requestName);
                  this.ptr.resolvedRequestType = a;
                  a = this.ptr.parent.resolve(this.ptr.responseName);
                  if (!(a && a instanceof c.Reflect.Message))
                    throw Error("Illegal response type reference in " + this.ptr.toString(!0) + ": " + this.ptr.responseName);
                  this.ptr.resolvedResponseType = a;
                } else
                  throw Error("Illegal service method type in " + this.ptr.toString(!0));
              else
      ...
      g.loadProto = function(c, b, l) {
        if ("string" == typeof b || b && "string" === typeof b.file && "string" === typeof b.root)
          l = b, b = null;
      ...
      g.loadProtoFile = function(c, b, l) {
        ...
        if (b)
          g.Util.fetch("object" === typeof c ? c.root + "/" + c.file : c, function(a) {
            b(g.loadProto(a, l, c));
          });
        else {
          var k = g.Util.fetch("object" === typeof c ? c.root + "/" + c.file : c);
          return null !== k ? g.protoFromString(k, l, c) : null;
        }
      };
