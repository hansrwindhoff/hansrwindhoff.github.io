    ...
    !function(b) {
      ...
      var s,
          ...
          r = function(d) {
            ...
            return d && (a.constructor = function(a) {
              a(i, i);
            }), (b = c.resolve(a))["catch"](i), b === a;
          },
          h = function() {
            function P2(b) {
              var a = new c(b);
              return q(a, P2.prototype), a;
            }
            var a = !1;
            try {
              if (a = c && c.resolve && r(), q(P2, c), P2.prototype = l.create(c.prototype, {constructor: {value: P2}}), P2.resolve(5).then(function() {}) instanceof P2 || (a = !1), a && b(8)) {
                var d = !1;
                c.resolve(l.setDesc({}, "then", {get: function() {
                    d = !0;
                  }})), a = d;
              }
            } catch (e) {
              ...
              v(function() {
                for (var e = b.v,
                    ...
                    h = function(a) {
                      var c,
                          ...
                          d = a.reject;
                      try {
                        g ? (f || (b.h = !0), c = g === !0 ? e : g(e), c === a.promise ? d(TypeError("Promise-chain cycle")) : (h = u(c)) ? h.call(c, i, d) : i(c)) : d(e);
                      } catch (j) {
                        d(j);
                      }
                    }; c.length > g; )
                ...
                c.length = 0, b.n = !1, d && setTimeout(function() {
                  var f,
                      c,
                      d = b.p;
                  y(d) && (H ? o.emit("unhandledRejection", e, d) : (f = k.onunhandledrejection) ? f({
                    promise: d,
                    reason: e
                  }) : (c = k.console) && c.error && c.error("Unhandled promise rejection", e)), b.a = a;
                }, 1);
              });
            }
          },
          y = function(e) {
            ...
            if (b.h)
              return !1;
            for (; c.length > d; )
              if (a = c[d++], a.fail || !y(a.promise))
                return !1;
            return !0;
          },
          f = function(b) {
            var a = this;
            a.d || (a.d = !0, a = a.r || a, a.v = b, a.s = 2, a.a = a.c.slice(), n(a, !0));
          },
          x = function(b) {
            var c,
                a = this;
      ...
      h || (c = function Promise(d) {
        ...
        then: function then(d, e) {
          var a = new g(z(this, c)),
              f = a.promise,
              b = this._d;
          return a.ok = "function" == typeof d ? d : !0, a.fail = "function" == typeof e && e, b.c.push(a), b.a && b.a.push(a), b.s && n(b, !1), f;
        },
        "catch": function(b) {
          return this.then(a, b);
        }
      })), d(d.G + d.W + d.F * !h, {Promise: c}), b(35)(c, e), b(117)(e), s = b(5)[e], d(d.S + d.F * !h, e, {reject: function reject(b) {
          var a = new g(this),
              c = a.reject;
          return c(b), a.promise;
        }}), d(d.S + d.F * (!h || r(!0)), e, {resolve: function resolve(a) {
          if (a instanceof c && C(a.constructor, this))
            return a;
          var b = new g(this),
              d = b.resolve;
          return d(a), b.promise;
        }}), d(d.S + d.F * !(h && b(111)(function(a) {
      ...
      g.exports = function(g, s, w, r, p, o) {
        ...
        }), "size" in q && d.setDesc(b.prototype, "size", {get: function() {
            return this._c.size;
      ...
      var b = a(3),
          c = Function.apply,
          d = a(17);
      b(b.S, "Reflect", {apply: function apply(a, b, e) {
          return c.call(a, b, d(e));
        }});
    }, function(h, i, a) {
      var e = a(2),
          b = a(3),
          ...
          f = a(17),
          d = a(13),
          g = Function.bind || a(5).Function.prototype.bind;
      b(b.S + b.F * a(9)(function() {
        function F() {}
        return !(Reflect.construct(function() {}, [], F) instanceof F);
      }), "Reflect", {construct: function construct(b, a) {
          c(b), f(a);
          var i = arguments.length < 3 ? b : c(arguments[2]);
          if (b == i) {
            switch (a.length) {
              case 0:
                return new b;
            ...
            var h = [null];
            return h.push.apply(h, a), new (g.apply(b, h));
          }
          var j = i.prototype,
              k = e.create(d(j) ? j : Object.prototype),
              l = Function.apply.call(b, k, a);
          return d(l) ? l : k;
        }});
    }, function(e, f, a) {
      var c = a(2),
