...
if (require("./$.descriptors")) {
  ...
  var isTAIndex = function(target, key) {
    return isObject(target) && TYPED_ARRAY in target && typeof key != 'symbol' && key in target && String(+key) == String(key);
  };
  ...
  module.exports = function(KEY, BYTES, wrapper, CLAMPED) {
    ...
    TAG in TypedArrayPrototype || $.setDesc(TypedArrayPrototype, TAG, {get: function() {
        return NAME;
      }});
    O[NAME] = TypedArray;
